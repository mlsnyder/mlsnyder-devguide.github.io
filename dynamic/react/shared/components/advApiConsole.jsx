...
const AdvApiConsole = (props) => {
  ...
  <raml-console-loader src="api.raml" options="{ disableTitle: true, disableThemeSwitcher: true, disableRamlClientGenerator: true, documentationCollapsed: true, disableTitle: true, disableDiscription: true, singleView: true }"></raml-console-loader>
